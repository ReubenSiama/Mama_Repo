...
<div class="col-md-6 col-md-offset-3" align="center" style="border-radius: 5px;">
	<div class="panel panel-primary" >
		<div class="panel-heading" style="padding:0.5% 1% 0.5% 1%; ">
		<h4 style="text-align:left;padding-left:2%">Buyer Registration</h4>
		</div>
		<div class="panel-body" style="background-color:#E0F8E6">
			...
			<p><input type="checkbox" name="agree" id="agree">
			 ...
			 <div class="text-center">
			 	...
			 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			 	<input type="reset"  name="resetbtn" id='resetbtn' class="btn btn-md btn-warning" style="width:20%">
			 </div>
			</form>
		</div>
	</div>
...
<script type="text/javascript">
	...
	function validateform(){
		...
		if(x.value.length > 0 && y.value.length > 0 && z.value.length > 0 && y.value.length === 10 ){
			...
			alert('Please Enter 10 Digits in Number field');
			y.value='';
			return false;
		}
	}
