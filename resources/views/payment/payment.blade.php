...
<table width='100%' cellpadding='0' cellspacing="0" ><tr><th width='90%'>&nbsp;</th></tr></table>
	...
	<form  method="post" action="{{ URL::to('/')}}/posting" name="frmTransaction" id="frmTransaction" > 
	{{ csrf_field() }}
     <table width="600" cellpadding="2" cellspacing="2" border="0">
	   ...
	   <tr>
		...
		<tr>
		  ...
		  <td align="left"><input name="return_url" type="text" size="60" value="{{URL::to('/')}}/payment/response" /></td>
	   </tr>
		<tr>
