    ...
    <div class="panel panel-primary" >
        ...
        <div class="panel-body" style="background-color:white">
            ...
            <p><input type="checkbox" name="agree" id="agree" checked>
             &nbsp;&nbsp;I agree to the <a href="{{ URL::to('/') }}/terms" style="text-decoration: none;">Terms and Conditions </a></p><br><br>
            <div class="text-center">
                <input type="submit" name="cregister" id='cregister' class="btn btn-md" style="width:20%; background-color: rgb(22, 138, 67);color:white">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
