        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                <div class="panel-heading">
                  <p>Please Add Project Details </p>
                </div>                
                               ...
                               <tr>
                                   ...
                                   <td>
                                    <div class="row">
                                      ...
                                      <div class="col-md-3">
                                        <input value="{{ old('ground') }}" onkeyup="check('ground');" autocomplete="off" name="ground" id="ground" type="text" class="form-control input-sm" placeholder="Ground">
                                      </div>
                                      <div class="col-md-3">
                                        <p id="total"></p>
                                      </div>
...
<script type="text/javascript">
  ...
  function getLocation(){
      ...
      alert("Oops.. No Geo-Location Support Found!");
    } 
  }
